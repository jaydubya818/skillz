...
| Builder.io, Agent-Native, and `factory*` skills | vendored from [BuilderIO/skills](https://github.com/BuilderIO/skills), pinned in `vendor/builderio.json`; portability changes are generated by `scripts/vendor_builderio.py` |
